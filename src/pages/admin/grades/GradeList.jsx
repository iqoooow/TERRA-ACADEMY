    ...
    return (
        <div className="space-y-8 animate-fade-in max-w-[1600px] mx-auto pb-10">
            ...
            <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 shadow-lg">
                <div className="absolute inset-0 bg-gradient-to-br from-violet-700 via-purple-700 to-slate-900 opacity-95"></div>
            ...
            <div className="glass-card p-2 flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-24 z-30">
                ...
                <div className="flex gap-2 p-1 w-full md:w-auto">
                    ...
                    <button className="flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-xl hover:bg-slate-800 transition-all font-black text-[10px] uppercase tracking-widest shadow-lg shadow-slate-900/20 active:scale-95">
